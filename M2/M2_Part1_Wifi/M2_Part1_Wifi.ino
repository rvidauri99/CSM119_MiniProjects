/*
What: Tutorial on how to connect the Nano 33 IoT to a WiFi Network
Where: https://docs.arduino.cc/tutorials/nano-33-iot/wifi-connection
Why: This helps as a quick and easy way to get familiar on using the
arduino and its WiFi communications capabilities. As per instructions, 
we follow along and replicate the tutorial.
*/
...
char pass[] = "FILL IN";                // your network password (use for WPA, or use as key for WEP)
